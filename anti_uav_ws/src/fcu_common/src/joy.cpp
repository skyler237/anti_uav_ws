...
Joy::Joy() {
  ...
  pnh.param<double>("reset_orient_y", reset_pose_.orientation.y, 0.0);
  pnh.param<double>("reset_orient_z", reset_pose_.orientation.z, 0.0);
  pnh.param<double>("reset_orient_w", reset_pose_.orientation.w, 0.0); 
  ...
  pnh.param<double>("reset_angular_twist_y", reset_twist_.angular.y, 0.0);
  pnh.param<double>("reset_angular_twist_z", reset_twist_.angular.z, 0.0);
